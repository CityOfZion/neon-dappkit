...
(0, mocha_1.describe)('NeonParser', function () {
    this.timeout(60000);
    (0, mocha_1.it)('converts an ArrayBuffer into a hex string', () => __awaiter(this, void 0, void 0, function* () {
        const encoder = new TextEncoder();
        const arrayBuffer = encoder.encode('unit test');
        const hexString = '756e69742074657374';
        assert.equal(_1.NeonParser.abToHex(arrayBuffer), hexString);
    }));
    (0, mocha_1.it)('converts an ArrayBuffer into a string', () => __awaiter(this, void 0, void 0, function* () {
        const encoder = new TextEncoder();
        const str = 'unit test';
        const arrayBuffer = encoder.encode(str);
        assert.equal(_1.NeonParser.abToStr(arrayBuffer), str);
    }));
    (0, mocha_1.it)('converts an account input into its address', () => __awaiter(this, void 0, void 0, function* () {
        ...
        assert.equal(_1.NeonParser.accountInputToAddress(privateKey), address);
        assert.equal(_1.NeonParser.accountInputToAddress(publicKey), address);
        assert.equal(_1.NeonParser.accountInputToAddress(scriptHash), address);
    }));
    (0, mocha_1.it)('converts an account input into its scripthash', () => __awaiter(this, void 0, void 0, function* () {
        const scriptHash = 'a5de523ae9d99be784a536e9412b7a3cbe049e1a';
        const privateKey = '087780053c374394a48d685aacf021804fa9fab19537d16194ee215e825942a0';
        const publicKey = '03cdb067d930fd5adaa6c68545016044aaddec64ba39e548250eaea551172e535c';
        const address = 'NNLi44dJNXtDNSBkofB48aTVYtb1zZrNEs';
        assert.equal(_1.NeonParser.accountInputToScripthash(privateKey), scriptHash);
        assert.equal(_1.NeonParser.accountInputToScripthash(publicKey), scriptHash);
        assert.equal(_1.NeonParser.accountInputToScripthash(address), scriptHash);
    }));
    (0, mocha_1.it)('converts a base64 string to a hex string', () => __awaiter(this, void 0, void 0, function* () {
        let base64String = 'dW5pdCB0ZXN0';
        let hexString = '756e69742074657374';
        assert.equal(_1.NeonParser.base64ToHex(base64String), hexString);
        base64String = 'TmVvblBhcnNlcg==';
        hexString = '4e656f6e506172736572';
        assert.equal(_1.NeonParser.base64ToHex(base64String), hexString);
    }));
    (0, mocha_1.it)('converts a base64 string to a hex and revert it', () => __awaiter(this, void 0, void 0, function* () {
    ...
    (0, mocha_1.it)('converts a base64 string into an utf-8 string', () => __awaiter(this, void 0, void 0, function* () {
        const base64String = 'VVRGLTggU3RyaW5nIMOhw6PDoMOn';
        const utf8String = 'UTF-8 String áãàç';
        assert.equal(_1.NeonParser.base64ToUtf8(base64String), utf8String);
    }));
    (0, mocha_1.it)('converts a hex string into a base64 string', () => __awaiter(this, void 0, void 0, function* () {
        let base64String = 'dW5pdCB0ZXN0';
        let hexString = '756e69742074657374';
        assert.equal(_1.NeonParser.hexToBase64(hexString), base64String);
        base64String = 'TmVvblBhcnNlcg==';
        hexString = '4e656f6e506172736572';
        assert.equal(_1.NeonParser.hexToBase64(hexString), base64String);
    }));
    (0, mocha_1.it)('converts a hex string into an array buffer', () => __awaiter(this, void 0, void 0, function* () {
        const encoder = new TextEncoder();
        const arrayBuffer = encoder.encode('unit test');
        const hexString = '756e69742074657374';
        assert.deepEqual(_1.NeonParser.hexToAb(hexString), arrayBuffer);
    }));
    (0, mocha_1.it)('converts a hex string into a string', () => __awaiter(this, void 0, void 0, function* () {
        let str = 'unit test';
        let hexString = '756e69742074657374';
        assert.equal(_1.NeonParser.hexToStr(hexString), str);
        str = 'NeonParser';
        hexString = '4e656f6e506172736572';
        assert.equal(_1.NeonParser.hexToStr(hexString), str);
    }));
    (0, mocha_1.it)('converts a number into a hex string intToHex', () => __awaiter(this, void 0, void 0, function* () {
        let num = 16;
        let hexString = '10';
        assert.equal(_1.NeonParser.intToHex(num), hexString);
        num = 512;
        hexString = '0200';
        assert.equal(_1.NeonParser.intToHex(num), hexString);
    }));
    (0, mocha_1.it)('converts a number into a hex string numToHexstring', () => __awaiter(this, void 0, void 0, function* () {
        let num = 16;
        let hexString = '10';
        assert.equal(_1.NeonParser.numToHex(num), hexString);
        num = 512;
        hexString = '00';
        assert.equal(_1.NeonParser.numToHex(num), hexString);
        num = 512;
        hexString = '0200';
        assert.equal(_1.NeonParser.numToHex(num, 2), hexString);
        num = 512;
        hexString = '0002';
        assert.equal(_1.NeonParser.numToHex(num, 2, true), hexString);
    }));
    (0, mocha_1.it)('converts a number into a variable length Int', () => __awaiter(this, void 0, void 0, function* () {
        let num = 16;
        let str = '10';
        assert.equal(_1.NeonParser.numToVarInt(num), str);
        num = 512;
        str = 'fd0002';
        assert.equal(_1.NeonParser.numToVarInt(num), str);
        num = 65535;
    ...
    (0, mocha_1.it)('reverts a hex string', () => __awaiter(this, void 0, void 0, function* () {
        const hexString = 'abcdef';
        const reverseHexString = 'efcdab';
        assert.equal(_1.NeonParser.reverseHex(hexString), reverseHexString);
    }));
    (0, mocha_1.it)('converts a string into an array buffer', () => __awaiter(this, void 0, void 0, function* () {
        const encoder = new TextEncoder();
        const str = 'unit test';
        const arrayBuffer = encoder.encode(str);
        assert.deepEqual(_1.NeonParser.strToAb(str), arrayBuffer);
    }));
    (0, mocha_1.it)('converts a string into a base64 string ', () => __awaiter(this, void 0, void 0, function* () {
        let str = 'unit test';
        let base64String = 'dW5pdCB0ZXN0';
        assert.equal(_1.NeonParser.strToBase64(str), base64String);
        str = 'NeonParser';
        base64String = 'TmVvblBhcnNlcg==';
        assert.equal(_1.NeonParser.strToBase64(str), base64String);
    }));
    (0, mocha_1.it)('converts a string into a hex string', () => __awaiter(this, void 0, void 0, function* () {
        let str = 'unit test';
        let hexString = '756e69742074657374';
    ...
    (0, mocha_1.it)('converts a ascii string into a base64 string', () => __awaiter(this, void 0, void 0, function* () {
        let asciiString = 'unit test';
        let base64String = 'dW5pdCB0ZXN0';
        assert.equal(_1.NeonParser.asciiToBase64(asciiString), base64String);
        asciiString = 'NeonParser';
        base64String = 'TmVvblBhcnNlcg==';
        assert.equal(_1.NeonParser.asciiToBase64(asciiString), base64String);
    }));
    (0, mocha_1.describe)('parseRpcResponse', function () {
        ...
        (0, mocha_1.it)('parses ScriptHash and ScriptHashLittleEndian', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const scriptHashLilEndian = _1.NeonParser.parseRpcResponse(rpcResponse, {
                type: 'Hash160',
        ...
        (0, mocha_1.it)('parses Union', () => __awaiter(this, void 0, void 0, function* () {
            ...
            let union = _1.NeonParser.parseRpcResponse(rpcResponse, {
                type: 'Any',
            ...
            union = _1.NeonParser.parseRpcResponse(rpcResponse, {
                type: 'Any',
                union: [{ type: 'String' }, { type: 'Integer' }],
            });
        ...
        (0, mocha_1.it)('parses same internal types with Union', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const str = _1.NeonParser.parseRpcResponse(rpcResponse, {
                type: 'Any',
    ...
    (0, mocha_1.describe)('formatRpcArgument', () => {
        (0, mocha_1.it)('format numbers', () => __awaiter(this, void 0, void 0, function* () {
        ...
        (0, mocha_1.it)('format boolean', () => __awaiter(this, void 0, void 0, function* () {
        ...
        (0, mocha_1.it)('format string', () => __awaiter(this, void 0, void 0, function* () {
        ...
        (0, mocha_1.it)('format ByteArray', () => __awaiter(this, void 0, void 0, function* () {
            let byteArrayValue = _1.NeonParser.strToHex('unit test');
            ...
            byteArrayValue = _1.NeonParser.strToHex('another value 1234');
        ...
        (0, mocha_1.it)('format Hash160', () => __awaiter(this, void 0, void 0, function* () {
        ...
        (0, mocha_1.it)('format Hash256', () => __awaiter(this, void 0, void 0, function* () {
        ...
        (0, mocha_1.it)('format PublicKey', () => __awaiter(this, void 0, void 0, function* () {
        ...
        (0, mocha_1.it)('format array of primitive types', () => __awaiter(this, void 0, void 0, function* () {
            ...
            assert.deepStrictEqual(arrayArg, expectedResult);
            assert.deepStrictEqual(arrayArg, arrayArgNoConfig);
            arrayArg = _1.NeonParser.formatRpcArgument(['756e6974', '74657374'], {
                type: 'Array',
        ...
        (0, mocha_1.it)('format map of primitive types', () => __awaiter(this, void 0, void 0, function* () {
            ...
            assert.deepStrictEqual(mapArg, expectedResult);
            assert.notDeepStrictEqual(mapArg, mapArgNoConfig);
            mapArg = _1.NeonParser.formatRpcArgument({ '627974654172726179': _1.NeonParser.strToHex('unit test') }, { type: 'Map', genericKey: { type: 'ByteArray' }, genericItem: { type: 'ByteArray' } });
            mapArgNoConfig = _1.NeonParser.formatRpcArgument({ '627974654172726179': _1.NeonParser.strToHex('unit test') });
            expectedResult = {
                type: 'Map',
                value: [
                    {
        ...
        (0, mocha_1.it)('format Any', () => __awaiter(this, void 0, void 0, function* () {
